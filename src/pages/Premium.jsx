    ...
    const plans = [
        {
            ...
            price: 69,
            originalPrice: 199,
            features: ['Unlock All Templates', 'Basic Analytics', 'Remove Branding'],
            color: 'bg-white',
        ...
        },
        {
            ...
            price: 269,
            originalPrice: 1194,
            features: ['Everything in Monthly', 'Priority Support', 'Advanced Analytics', 'SEO Optimization'],
        ...
        },
        {
            ...
            price: 569,
            originalPrice: 2388,
            features: ['Everything in Half-Yearly', 'Dedicated Account Manager', 'Custom Domain Support', 'Early Access to New Features'],
            color: 'bg-white',
            border: 'border-slate-200',
            button: 'bg-slate-900 text-white hover:bg-black',
        },
