...
const CardItem = ({ card, isLiked, isSaved, onLike, onSave, onView, ratingAvg, ratingCount, isVerified }) => {
    ...
    return (
        <div className="bg-white rounded-[32px] p-6 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] hover:scale-[1.02] transition-all duration-300 relative group border border-gray-50">
            {/* Top Rated Tag */}
