                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {card.has_active_offer && (
                            <Link
                                ...
                                className="text-[10px] uppercase tracking-wider font-bold text-white bg-red-600 px-3 py-1 rounded-full animate-pulse hover:bg-red-700 pointer-events-auto shadow-lg"
                            >
                                OFFER
                            </Link>
                        )}
                    ...
                    <div className="flex justify-center gap-4 py-4">
                        {Object.entries(card.social_links).map(([platform, url]) => (
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className={`w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg shadow-slate-200 ${platform.toLowerCase() === 'whatsapp' ? 'bg-[#25D366] text-white' : 'bg-slate-800 text-white'}`}
                            >
