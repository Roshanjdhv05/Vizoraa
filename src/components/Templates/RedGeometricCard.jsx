                            ...
                            <div className="flex flex-wrap gap-2 mt-4 md:mt-6">
                                ...
                                {card.social_links && Object.entries(card.social_links).map(([platform, url]) => (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className={`w-7 h-7 rounded-full flex items-center justify-center transition-colors ${platform.toLowerCase() === 'whatsapp' ? 'bg-[#25D366] text-white hover:text-white' : 'bg-slate-100 text-slate-500 hover:text-white'}`}
                                        style={{ '--hover-color': themeColor }}
                                        onMouseEnter={(e) => {
